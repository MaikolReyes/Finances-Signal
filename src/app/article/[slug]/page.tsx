...
import { NewsRelations } from '@/components';
...
export default function Article() {
    ...
    // Cambiar el título dinámicamente (solución temporal)
    useEffect(() => {
    ...
    return (
        ...
        <>
            ...
            <div key={id} className="flex flex-col justify-center w-full p-3 md:p-2 mx-auto md:w-2/4 2xl:w-2/5">

                <h1 className="text-xl mt-2 font-secondary font-bold text-gray-800 md:text-3xl">{title}</h1>
